...
<div class="container">
    <div class="card">
        <div class="top-buttons text-end mb-3">
            ...
            <a href="add_allocation.php" class="btn btn-primary">Add Allocation</a>
        </div>
...
<button 
    ...
    <a href="edit_allocations.php?id=<?php echo $row['allocation_id']; ?>" class="btn btn-primary btn-sm">Edit</a>
